...
```
cd existing_repo
git remote add origin https://gitlab.com/qudratjon03031999/test_shogirt.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/qudratjon03031999/test_shogirt/-/settings/integrations)
